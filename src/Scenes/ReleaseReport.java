...
public class ReleaseReport {
    ...
    public static Scene ReleaseReportDisplay(Stage app){
        Scene ReleaseReport;
        ...
        drukuj.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent e) {
                ...
                //    Main.this.getHostServices().showDocument("Raporty\\Wydane puszki.txt");
        ...
        String time5 = (new SimpleDateFormat("dd.MM.yyyy HH:mm:ss")).format(Calendar.getInstance().getTime());
        Label timeInput = new Label(time5);
        ...
        ReleaseReport = new Scene(grid, 650.0D, 450.0D);
